...
class QuestItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest_item" do
    assert_difference("QuestItem.count") do
      post quest_items_url, params: { quest_item: { is_done: @quest_item.is_done, quest: @quest_item.quest } }
    end
  ...
  test "should update quest_item" do
    patch quest_item_url(@quest_item), params: { quest_item: { is_done: @quest_item.is_done, quest: @quest_item.quest } }
